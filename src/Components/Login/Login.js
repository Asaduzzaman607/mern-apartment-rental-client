    ...
    <div className="container login-container">
      <div className="login-form">
        <div className="login-page-inner">
          ...
          <form onSubmit={haveAccount ? handleSignIn : handleSignUp}>
            ...
            {haveAccount && (
              ...
              >
                ...
                <div>
                  <p onClick={resetPassword} className="forget-password">
                    Forget Password
                  </p>
                </div>
              </div>
          ...
          <p className="about-account">
            {!haveAccount ? "Already have an account?" : "Create An Account"}{" "}
            <span
              style={{
                color: "#275A53",
                cursor: "pointer",
        ...
        <div className="continue-with-facebook" onClick={handleFbSignIn}>
